  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            icon: Users.userLogged.bookmarks.contains(recipe)
        ...
        children: <Widget>[
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CookingScreen(recipe)),
                        );
                      },
                    ),
                  ),
          ...
          Container(
            ...
            child: TabBar(
              ...
              tabs: const <Widget>[
                // The tab texts should be in black
                Tab(
                  text: 'Ingredients',
                ),
                Tab(
        ...
        children: <Widget>[
          ...
          Center(
            child: ElevatedButton.icon(
              style: ButtonStyle(
                backgroundColor:
                    MaterialStateProperty.all<Color>(GrateMate.yellowNorthFace),
              ...
              onPressed: () {
                if (!Users.isLogged) {
                  ...
                  recipe.ingredients.forEach((ingredient) {
                    ...
                    Tuple2<Ingredient, int> isContained = Users
                        .userLogged.shoppingList
                        .firstWhere((e) => e.item1 == ingredient.item1,
                            orElse: () => Tuple2(ingredient.item1, 0));
                    if (isContained.item2 != 0) {
                      int index =
                          Users.userLogged.shoppingList.indexOf(isContained);
                      Users.userLogged.shoppingList[index] = Tuple2(
                          Users.userLogged.shoppingList[index].item1,
                          Users.userLogged.shoppingList[index].item2 +
                              ingredient.item2 * servings);
                    } else {
                      Users.userLogged.shoppingList.add(Tuple2(
                          ingredient.item1, ingredient.item2 * servings));
                    }
                  });
                }
                if (Users.isLogged) {
